...
class JogosControllerTest < ActionController::TestCase
  ...
  test "should create jogo" do
    assert_difference('Jogo.count') do
      post :create, jogo: { categoria: @jogo.categoria, nome: @jogo.nome, plataforma: @jogo.plataforma }
    end
  ...
  test "should update jogo" do
    patch :update, id: @jogo, jogo: { categoria: @jogo.categoria, nome: @jogo.nome, plataforma: @jogo.plataforma }
    assert_redirected_to jogo_path(assigns(:jogo))
  end
