class JogosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @jogo.save
        format.html { redirect_to @jogo, notice: 'Jogo foi cadastrado' }
  ...
  def update
    respond_to do |format|
      if @jogo.update(jogo_params)
        format.html { redirect_to @jogo, notice: 'Jogo foi atualizado' }
  ...
  def destroy
    @jogo.destroy
    respond_to do |format|
      format.html { redirect_to jogos_url, notice: 'Jogo foi excluido' }
  ...
  private
    ...
    def jogo_params
      params.require(:jogo).permit(:nome, :plataforma, :categoria)
    end
end
